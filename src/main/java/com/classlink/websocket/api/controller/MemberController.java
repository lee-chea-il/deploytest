...
public class MemberController {
	...
	public void memberIdentityAdd(WebSocketSession session, RequestPacket packetReqProto, String userId) throws StreamReadException, DatabindException, IOException {
	...
	public void IdentityAvartarAdd(WebSocketSession session, RequestPacket packetReqProto, String userId) throws StreamReadException, DatabindException, IOException {
		session.sendMessage(memberService.addAvartar(packetReqProto, userId));
	}
	
	@OpCodeMapping(value = OpCode.AVARTAR_INFO)
	public void IdentityAvartarInfo(WebSocketSession session, RequestPacket packetReqProto, String userId) throws StreamReadException, DatabindException, IOException {
		session.sendMessage(memberService.findAvartarByMemberId(packetReqProto, userId));
	}
	
	@OpCodeMapping(value = OpCode.AVARTAR_CHANGE)
	public void IdentityAvartarChange(WebSocketSession session, RequestPacket packetReqProto, String userId) throws StreamReadException, DatabindException, IOException {
